...
.agents/skills/tui-capture/scripts/capture_tui.sh target/debug/nhl /tmp/cap
```
...
.agents/skills/tui-capture/scripts/capture_tui.sh /path/to/main-checkout/target/debug/nhl /tmp/cap_main
.agents/skills/tui-capture/scripts/capture_tui.sh target/debug/nhl /tmp/cap_new
